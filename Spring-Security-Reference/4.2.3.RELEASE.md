...
__<sup id="footnote1">1</sup>__ 마일스톤(Milestone)은 프로젝트 진행 과정에서 어떤 중요한 시점을 의미한다. 따라서 마일스톤 배포라고 하면 정식 배포 버전은 아니지만 어떠한 중요한 업그레이드를 위한 배포라고 생각하면 될 듯 하다. -옮긴이 [↩](#footkey1)
