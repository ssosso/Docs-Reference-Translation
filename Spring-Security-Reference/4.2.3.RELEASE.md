...
__<sub id="footnote2">#2</sub>__ <sub>이행적 의존성(transitive dependencies)이란, 한 가지 의존성에 대해 2가지 이상의 버전을 포함하고 있을 경우, 충돌이 발생하면 특정 기준에 따라 이행할 의존성이 선택되는 것을 말한다.(http://www.baeldung.com/spring-maven-bom 참고) -옮긴이 ([읽던 곳으로 돌아가기](#footkey2))</sub>
